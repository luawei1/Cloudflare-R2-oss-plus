...
const emit = defineEmits(["update:modelValue", "upload", "createFolder", "importLink"]);
</script>
    ...
    <Transition name="slide-up">
      <div v-if="modelValue" class="popup-content">
        ...
        <div class="button-grid">
          ...
          <button class="upload-option" type="button" @click="emit('importLink')">
            <div class="upload-option-icon link">
